<x-front-pages>
	<div class="w-full flex items-center">
		<h2 class="min-w-max text-xl font-bold mb-2 -mt-10 px-4 capitalize bg-secondary text-white text-center">{{ $subcategory->name }}</h2>
	</div>

	@if(empty($mostPopularArticles) && empty($popularArticles) && empty($otherArticles))
		<p class="text-lg mt-4">There is no articles in this subcategory.</p>
	@elseif(empty($mostPopularArticles))
